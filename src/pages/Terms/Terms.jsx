        ...
        <header className="relative py-20 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <nav className="flex items-center justify-center gap-2 text-sm mb-8">
              ...
              <i className="fa-solid fa-chevron-right w-4 h-4 text-neutral-600 rotate-180"></i>
            ...
            <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-500/10 backdrop-blur-sm rounded-2xl border border-orange-500/30 mb-6">
              <i className="fa-regular fa-file-lines w-8 h-8 text-orange-500 text-3xl"></i>
            </div>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-6 mb-12">
            <div className="flex gap-4">
              <div className="shrink-0">
                <i className="fa-solid fa-triangle-exclamation w-6 h-6 text-yellow-500"></i>
              </div>
          ...
          <div className="space-y-12">
            <section className="group">
              <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                <span className="flex items-center justify-center w-8 h-8 bg-linear-to-brr from-orange-500 to-yellow-500 text-white text-sm font-bold rounded-lg">
                  1
                </span>
                الموافقة على الشروط
              </h2>
              ...
              <div className="pr-11">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-3 text-neutral-400">
                    <i className="fa-regular fa-circle-xmark w-5 h-5 text-red-400 shrink-0 mt-0.5"></i>
            ...
            <section className="group">
              ...
              <div className="pr-11">
                ...
                >
                  <i className="fa-regular fa-envelope w-5 h-5"></i>
                  hello@adasah.com
                </a>
              </div>
            </section>
