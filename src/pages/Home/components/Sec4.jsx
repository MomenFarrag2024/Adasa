      ...
      <section className="py-24 bg-[#0a0a0a] relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
            <div>
              <span className="items-center gap-2 px-4 py-2 text-sm font-medium text-orange-500 bg-orange-500/10 border border-orange-500/30 rounded-full inline-flex before:content-[''] before:h-1.5 before:w-1.5 before:bg-orange-500 before:rounded-full before:animate-pulse mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {data.posts.slice(3, 6).map((post, index) => (
              <article
                key={post.id}
                className="group bg-[#161616] border border-[#262626] rounded-3xl transition-all duration-500 overflow-hidden"
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-[#262626]">
                      ...
                      <div className="w-8 h-8 rounded-full bg-orange-500/10 flex items-center justify-center group-hover:bg-orange-500 transition-colors duration-300 border border-orange-500/20 group-hover:border-transparent">
                        <i className="fa-solid fa-chevron-right w-4 h-4 text-orange-500 group-hover:text-white transition-colors duration-300 rotate-180" />
                      </div>
                    </div>
                  </div>
                </Link>
